...
.PHONY: dev backend frontend stop install-deps build-docker up down logs
...
up:
	...
	@echo "   Frontend: http://localhost:8082 (internal)"
	@echo "   Nginx proxy: https://nuri-gpt.vodqar.com"
